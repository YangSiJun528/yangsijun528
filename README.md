...
- [[Spring Security](https://github.com/spring-projects/spring-security) | PR | 2023-11] [Update Javadoc Comments in AuthorizationEvent Class](https://github.com/spring-projects/spring-security/pull/14175)  
- [[Obsidian](https://github.com/obsidianmd/obsidian-translations) | PR | 2023-12] [Update ko.json](https://github.com/obsidianmd/obsidian-translations/pull/906)  
- [[springdoc](https://github.com/springdoc/springdoc.github.io) | Issue | 2024-04] [Enhance SpringDoc documentation for file upload API configuration](https://github.com/springdoc/springdoc.github.io/issues/77)  
- [[Spring Initializr](https://github.com/spring-io/initializr) | Issue | 2024-09] [Configure Kotlin's all-open plugin for JPA entities](https://github.com/spring-io/initializr/issues/1572)  
- [[Armeria](https://github.com/line/armeria) | PR | 2024-05] [Fix asJson method to pass mapper in WebClientRequestPreparation](https://github.com/line/armeria/pull/5512)  
